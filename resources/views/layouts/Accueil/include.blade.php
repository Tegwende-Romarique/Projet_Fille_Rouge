...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('Css/Accueil/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('Css/Accueil/preload.min.css')}}">
    <link rel="stylesheet" href="{{asset('Css/Accueil/plugins.min.css')}}">
    <link rel="stylesheet" href="{{asset('Css/Accueil/style.light-blue-500.min.css')}}">
    <link rel="stylesheet" href="{{asset('Css/Accueil/style.css')}}">
