...
<div class="bg-full-page bg-primary back-fixed">
    <div class="mw-500 absolute-center">
      <div class="card color-dark animated zoomInDown animation-delay-5">
        <div class="card-body">
          <h3 class="text-center text-uppercase">Ajouter un nouveau évènement</h3>
          <form class="form-horizontal" action="{{ url('ajouter-evenement')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <fieldset>
              <div class="form-group label-floating is-empty">
                <div class="input-group">
                  ...
                  <input type="text" id="titre" name="titre" class="form-control" placeholder="Titre de l'évènement" value="">
                </div>
              </div>
              ...
              <div class="form-group label-floating is-empty">
                <div class="input-group">
                  ...
                  <textarea cols="2" rows="2"  id="ms-form-pass" name="description" class="form-control" placeholder="Description de l'évènement" value=""></textarea>
                </div>
              </div>
      ...
      <a href="{{ url('liste-evenement')}}" class="btn btn-white"><i class="fa fa-home"></i> Retourner à liste des postes</a>
      </div>
    </div>
  </div>
